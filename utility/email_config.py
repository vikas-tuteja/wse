    ...
    'client': {
        'welcome': {
            'html': '<div style="font-family:Roboto;">\
                    ...
                    As an esteemed client you have an opportunity to post a requirement and we will provide you with the screened candidates to make the event a success (<a href="http://www.worksmartevents.com/termsandconditions">T&C Apply)<br>\
                    ...
                    You may update your profile from - http://www.worksmartevents.com/my-profile/overview/<br>\
                    In case of any queries please get in touch with us at +91-702-111-5997 (8AM - 9PM) or email at worksmartevent@gmail.com<br>\
                    <br>\
                    Regards, <br>\
